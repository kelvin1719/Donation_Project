        ...
        <div class="row no-gutters justify-content-between">
            <div class="col-auto d-flex align-items-center">
                ...
                <div class="header-logo">
                    <a class="header-logo__link" href="index.html">
                        <img class="header-logo__img logo--light" src="{{asset('assets/img/logo_white.png')}}" alt="logo"/>
                        <img class="header-logo__img logo--dark" src="{{asset('assets/img/logo_dark.png')}}" alt="logo"/>
                    </a>
                </div>
            </div>
            <div class="col-auto">
            ...
            <div class="col-auto d-flex align-items-center">
                ...
                <div class="dropdown-trigger d-block d-sm-none">
                    <div class="dropdown-trigger__item"></div>
                </div><a class="button button--squared" href="index.html#"><span>Donate</span></a>
            </div>
        </div>
    </div>
</header>
