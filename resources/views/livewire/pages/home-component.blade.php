<div>
    ...
    <section class="promo">
        <div class="promo-slider">
            <div class="promo-slider__item promo-slider__item--style-1">
                <picture>
                    <source srcset="{{asset('assets/img/375promo_1.jpg')}}" media="(min-width: 835px)"/>
                    <source srcset="{{asset('assets/img/375promo_1.jpg')}}" media="(min-width: 376px)"/>
                    <img class="img--bg" src="{{asset('assets/img/375promo_1.jpg')}}" alt="img"/>
                </picture>
                <div class="container">
                    <div class="row">
                        <div class="col-12">
            ...
            <div class="promo-slider__item promo-slider__item--style-2">
                <picture>
                    <source srcset="{{asset('assets/img/375promo_2.jpg')}}" media="(min-width: 835px)"/>
                    <source srcset="{{asset('assets/img/375promo_2.jpg')}}" media="(min-width: 376px)"/>
                    <img class="img--bg" src="{{asset('assets/img/375promo_2.jpg')}}" alt="img"/>
                </picture>
                <div class="container">
                    <div class="row">
                        <div class="col-xl-7">
            ...
            <div class="promo-slider__item promo-slider__item--style-3">
                <picture>
                    <source srcset="{{asset('assets/img/375promo_3.jpg')}}" media="(min-width: 835px)"/>
                    <source srcset="{{asset('assets/img/375promo_3.jpg')}}" media="(min-width: 376px)"/><img class="img--bg" src="{{asset('assets/img/375promo_3.jpg')}}" alt="img"/>
                </picture>
                <div class="container">
                    <div class="row">
        ...
        <div class="promo-pannel"><a class="anchor promo-pannel__anchor" href="index.html#about"> <span>Scroll Down</span></a>
            <div class="promo-pannel__video"><img class="img--bg" src="{{asset('assets/img/video_block.jpg')}}" alt="image"/><a class="video-trigger" href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"><span>Watch our video</span><i class="fa fa-play" aria-hidden="true"></i></a></div>
    ...
    <!-- icons section end-->
    <!-- causes start-->
    <section class="section causes"><img class="causes__bg" src="{{asset('assets/img/causes_img.png')}}" alt="img"/>
        <div class="container">
                        ...
                        <div class="causes-item causes-item--primary">
                            <div class="causes-item__body">
                                ...
                                <div class="causes-item__img">
                                    <div class="causes-item__badge" style="background-color: #49C2DF">Water Delivery</div><img class="img--bg" src="{{asset('assets/img/causes_1.jpg')}}" alt="img"/>
                                </div>
                    ...
                    <div class="causes-slider__item">
                        <div class="causes-item causes-item--primary">
                            <div class="causes-item__body">
                                ...
                                <div class="causes-item__img">
                                    <div class="causes-item__badge" style="background-color: #F36F8F">Medicine</div><img class="img--bg" src="{{asset('assets/img/causes_2.jpg')}}" alt="img"/>
                                </div>
                                <div class="causes-item__lower">
                                    <div class="progress-bar">
                    ...
                    <div class="causes-slider__item">
                        <div class="causes-item causes-item--primary">
                            <div class="causes-item__body">
                                ...
                                <div class="causes-item__img">
                                    <div class="causes-item__badge" style="background-color: #2EC774">Education</div><img class="img--bg" src="{{asset('assets/img/causes_3.jpg')}}" alt="img"/>
                                </div>
                                <div class="causes-item__lower">
                                    <div class="progress-bar">
                    ...
                    <div class="causes-slider__item">
                        <div class="causes-item causes-item--primary">
                            <div class="causes-item__body">
                                ...
                                <div class="causes-item__img">
                                    <div class="causes-item__badge" style="background-color: #F8AC3A">Food</div><img class="img--bg" src="{{asset('assets/img/causes_4.jpg')}}" alt="img"/>
                                </div>
                                <div class="causes-item__lower">
                                    <div class="progress-bar">
    ...
    <section class="section projects no-padding-top no-padding-bottom">
        ...
        <div class="row no-gutters projects-masonry">
            <div class="col-lg-6 col-xl-4 projects-masonry__item projects-masonry__item--height-1 projects-masonry__item--vertical">
                <div class="projects-masonry__img"><img class="img--bg" src="{{asset('assets/img/projects_1.jpg')}}" alt="img"/></div>
            ...
            <div class="col-lg-6 col-xl-8 projects-masonry__item projects-masonry__item--height-2 projects-masonry__item--horizontal">
                <div class="projects-masonry__img"><img class="img--bg" src="{{asset('assets/img/projects_2.jpg')}}" alt="img"/></div>
            ...
            <div class="col-lg-6 col-xl-8 projects-masonry__item projects-masonry__item--height-1 projects-masonry__item--primary">
                <div class="projects-masonry__img"><img class="img--bg" src="{{asset('assets/img/projects_3.jpg')}}" alt="img"/>
            ...
            <div class="col-lg-6 col-xl-4 projects-masonry__item projects-masonry__item--height-2 projects-masonry__item--primary">
                <div class="projects-masonry__img"><img class="img--bg" src="{{asset('assets/img/projects_4.jpg')}}" alt="img"/>
            ...
            <div class="col-lg-6 col-xl-8 projects-masonry__item projects-masonry__item--height-2 projects-masonry__item--horizontal">
                <div class="projects-masonry__img"><img class="img--bg" src="{{asset('assets/img/projects_5.jpg')}}" alt="img"/></div>
            ...
            <div class="col-lg-6 col-xl-4 projects-masonry__item projects-masonry__item--height-2 projects-masonry__item--primary">
                <div class="projects-masonry__img"><img class="img--bg" src="{{asset('assets/img/projects_6.jpg')}}" alt="img"/>
                    <div class="projects-masonry__inner"><span class="projects-masonry__badge" style="background: #F36F8F;">Medicine</span>
                        <h3 class="projects-masonry__title"> <a href="cause-details.html">Helpo for Help</a></h3>
                        <p>Gray eel-catfish longnose whiptail catfish smalleye squaretail queen danio unicorn fish shortnose greeneye fusilier fish silver carp</p>
                        <div class="projects-masonry__details-holder">
    ...
    <!-- projects end-->
    <!-- events start-->
    <section class="section events"><img class="events__bg" src="{{asset('assets/img/events_bg.png')}}" alt="img"/>
        <div class="container">
            <div class="row margin-bottom">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="event-item">
                        <div class="event-item__img"><img class="img--bg" src="{{asset('assets/img/event_1.jpg')}}" alt="img"/></div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="event-item">
                        <div class="event-item__img"><img class="img--bg" src="{{asset('assets/img/event_2.jpg')}}" alt="img"/></div>
                        <div class="event-item__content">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="event-item">
                        <div class="event-item__img"><img class="img--bg" src="{{asset('assets/img/event_3.jpg')}}" alt="img"/></div>
                        <div class="event-item__content">
                            <h6 class="event-item__title"><a href="index.html#">Help for Language. Voluanteer</a></h6>
                            <p><b>Dark Spurt,</b> San Francisco, CA 94528, USA</p>
            ...
            <div class="row">
                <div class="col-12 text-center"><a class="button button--primary" href="index.html#">View all events</a></div>
            </div>
        </div>
    </section>
    <!-- events end-->
    <!-- text section start-->
    <section class="section text-section"><img class="text-section__bg" src="{{asset('assets/img/text-section.png')}}" alt="img"/>
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-4 col-xl-7 offset-xl-4">
                    ...
                    <p>Sharksucker sea toad candiru rocket danio tilefish stingray deepwater stingray Sacramento splittail, Canthigaster rostrata. Midshipman dartfish Modoc sucker, yellowtail kingfish</p><a class="button button--primary" href="index.html#">Become a Volunteer</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section testimonials--style-2">
        <div class="testimonials--style-2__bg jarallax">
            <picture>
                <source srcset="{{asset('assets/img/testimonials_2.jpg')}}" media="(min-width: 992px)"/><img class="jarallax-img" src="{{asset('assets/img/testimonials_2.jpg')}}" alt="img"/>
            </picture>
        </div>
        <div class="container">
            <div class="row">
    ...
    <!-- blog start-->
    <section class="section blog"><img class="blog__bg" src="{{asset('assets/img/blog_bg.png')}}" alt="img"/>
        <div class="container">
            <div class="row margin-bottom">
                <div class="col-12">
            ...
            <div class="row offset-margin">
                <div class="col-md-6 col-lg-5 col-xl-4">
                    <div class="blog-item blog-item--style-1">
                        <div class="blog-item__img"><img class="img--bg" src="{{asset('assets/img/blog_1.jpg')}}" alt="img"/><span class="blog-item__badge" style="background-color: #49C2DF;">Water Delivery</span></div>
                ...
                <div class="col-md-6 col-lg-7 col-xl-8">
                    <div class="blog-item blog-item--style-2"><img class="img--bg" src="{{asset('assets/img/blog_2.png')}}" alt="img"/>
                ...
                <div class="col-md-6 col-lg-7 col-xl-8">
                    <div class="blog-item blog-item--style-2"><img class="img--bg" src="{{asset('assets/img/blog_3.png')}}" alt="img"/>
                ...
                <div class="col-md-6 col-lg-5 col-xl-4">
                    <div class="blog-item blog-item--style-1">
                        <div class="blog-item__img"><img class="img--bg" src="{{asset('assets/img/blog_4.png')}}" alt="img"/><span class="blog-item__badge" style="background-color: #F36F8F;">Medicine</span></div>
                        <div class="blog-item__content">
                            <h6 class="blog-item__title"><a href="index.html#">Save the Children's Role in Fight Against Malnutrition Hailed</a></h6>
                            <p>Sharksucker sea toad candiru rocket danio tilefish stingray deepwater stingray Sacramento splittail canthigaster</p>
                            <div class="blog-item__details"><span class="blog-item__date">23 Jan' 19</span><span>
                    ...
                    <div class="slider-holder">
                        <div class="donors-slider donors-slider--style-1">
                            <div class="donors-slider__item">
                                <div class="donors-slider__img"><img src="{{asset('assets/img/donor_1.png')}}" alt="donor"/></div>
                            </div>
                            <div class="donors-slider__item">
                                <div class="donors-slider__img"><img src="{{asset('assets/img/donor_2.png')}}" alt="donor"/></div>
                            </div>
                            <div class="donors-slider__item">
                                <div class="donors-slider__img"><img src="{{asset('assets/img/donor_3.png')}}" alt="donor"/></div>
                            </div>
                            <div class="donors-slider__item">
                                <div class="donors-slider__img"><img src="{{asset('assets/img/donor_4.png')}}" alt="donor"/></div>
                            </div>
                        </div>
                    </div>
                    <!-- donors slider end-->
    ...
    <section class="section instagram no-padding-bottom">
        ...
        <div class="instagram-slider">
            <a class="instagram-slider__item" href="index.html#">
                <img class="img--bg" src="{{asset('assets/img/ig_1.jpg')}}" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
            <a class="instagram-slider__item" href="index.html#">
                <img class="img--bg" src="{{asset('assets/img/ig_2.jpg')}}" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
            <a class="instagram-slider__item" href="index.html#">
                <img class="img--bg" src="{{asset('assets/img/ig_3.jpg')}}" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
            <a class="instagram-slider__item" href="index.html#">
                <img class="img--bg" src="{{asset('assets/img/ig_4.jpg')}}" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
            <a class="instagram-slider__item" href="index.html#">
                <img class="img--bg" src="{{asset('assets/img/ig_5.jpg')}}" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
            <a class="instagram-slider__item" href="index.html#">
                <img class="img--bg" src="{{asset('assets/img/ig_6.jpg')}}" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span>
                <span class="instagram-slider__icon-hover"><i class="fa fa-instagram" aria-hidden="true"></i></span>
            </a>
            <a class="instagram-slider__item" href="index.html#">
                <img class="img--bg" src="{{asset('assets/img/ig_4.jpg')}}" alt="img"/><span class="instagram-slider__icon"><i class="fa fa-instagram" aria-hidden="true"></i></span>
